...
public class SInfo
{
    ...
    public string 위험보험료Expr { get; set; } = string.Empty;
    public string 정기위험보험료Expr { get; set; } = string.Empty;
    public string SExpr { get; set; } = string.Empty;
    ...
    {
        return $"{MinSKey}\t{상품코드}\t{담보코드}\t{조건1}\t{조건2}\t{조건3}\t{Jong}\t{Freq}\t{Age}\t{n}\t{m}\t" +
